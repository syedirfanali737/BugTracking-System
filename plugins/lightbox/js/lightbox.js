...
var Lightbox = {	
	...
	updateDetails: function() {
		...
		//Gaurav added to correct the current photo num
		...
		if(this.imageArray.length > 1){
			var num_display = this.options.strings.numDisplayPrefix + ' ' + eval(buffer + this.activeImage + 1) + ' ' + this.options.strings.numDisplaySeparator + ' ' +(this.imageArray.length-1);
